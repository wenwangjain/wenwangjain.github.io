...
- <font color=Coral face=Georgia  align=center>《Machine Learning with Python Cookbook》</font>
...
{{% details title="<font color=DarkCyan face=Georgia  align=center size=3>sklearn.model_selection.train_test_split()</font>" %}}
...
{{% details title="<font color=DarkCyan face=Georgia  align=center size=3>***（1）K 折交叉验证：*** sklearn.model_selection.KFold()</font>" %}}
...
{{% details title="<font color=DarkCyan face=Georgia  align=center size=3>***（2）K 折交叉验证：*** sklearn.model_selection.cross_val_score()</font>" %}}
...
{{% details title="<font color=DarkCyan face=Georgia  align=center size=3>***（3）K 折交叉验证：*** sklearn.model_selection.KFold(), cross_val_score()</font>" %}}
...
{{% details title="<font color=DarkCyan face=Georgia  align=center size=3>***（4）留一交叉验证（留一法）：*** sklearn.model_selection.LeaveOneOut(), cross_val_score()</font>" %}}
