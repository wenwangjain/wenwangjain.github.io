...
flowchart LR
    ...
    D --> D2(模型部署<br>MLOps):::someclassB
          D2 --> D211(工程基础<br>git\github\Linux<br>容器<br>云<br>HF Spaces\<br>Streamlit Sharing) --> D212(MLOps 概述) --> D213(主要内容<br>自动化管道<br>监控<br>生命周期管理<br>治理) --> D214(部署工具<br>MLFlow<br>DVC<br>Polyaxon<br>Metaflow<br>Kubeflow) 
